...
public class SettingsLayout : MonoBehaviour
{
    ...
    private void FindExistingRefs()
    {
        ...
        if (sidebar != null)
        {
            SidebarAudioBg      = sidebar.Find("Btn_\U0001f50a Audio")?.GetComponent<Image>();
            SidebarLanguageBg   = sidebar.Find("Btn_\U0001f310 Language")?.GetComponent<Image>();
            SidebarControllerBg = sidebar.Find("Btn_\U0001f3ae Controller")?.GetComponent<Image>();
            ...
            SidebarSignOut      = sidebar.Find("Btn_\U0001f6aa SignOut")?.GetComponent<Button>();
